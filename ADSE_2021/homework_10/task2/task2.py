...
def on_message(client, userdata, msg):
    ...
    flag = 'on'
    flag_ = 'off'
    if current_payload == flag:
        pub_content = 'The light is shining'
    elif current_payload == flag_:
        pub_content = 'The light is not shining anymore'
    client.publish(global_pub_topic, pub_content)
